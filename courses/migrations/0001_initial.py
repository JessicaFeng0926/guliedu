    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('advanced', '高级'), ('intermediate', '中级'), ('beginning', '初级')], default='beginning', max_length=20, verbose_name='课程难度')),
                ('love_num', models.IntegerField(default=0, verbose_name='收藏数')),
                ('click_num', models.IntegerField(default=0, verbose_name='点击量')),
                ('desc', models.CharField(max_length=200, verbose_name='课程简介')),
                ('detail', models.TextField(verbose_name='课程详情')),
                ('category', models.CharField(choices=[('front_end', '前端开发'), ('back_end', '后端开发')], max_length=15, verbose_name='课程类别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(default='http://www.atguitu.com', verbose_name='视频链接')),
                ('add_time', models.DateTimeField(auto_now_add=True, verbose_name='添加时间')),
